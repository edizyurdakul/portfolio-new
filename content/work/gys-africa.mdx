---
title: 'GYS Africa'
summary: 'Worked on a contract basis, helped the online station, building their online presence, built and designed their website, implemented new solutions to generate more revenue(events, merch).'
...
skills:
  ...
  - TYPESCRIPT
  - CLOUDINARY
image: '/static/images/works/hamshackradio/gys-africa-banner.png'
githubUrl:
liveUrl: 'https://www.gys-africa.live/'
---

<Image
  alt={`Hamshack Radio Banner`}
  src={`/static/images/works/hamshackradio/gys-africa-banner.png`}
  width={1903}
  height={927}
  priority
/>
